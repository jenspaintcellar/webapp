...
export default function ClassesPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.content}>
      <div className={styles.sectionHeader}><div><p className={styles.eyebrow}>Explore</p><h2>Upcoming experiences</h2></div><div className={styles.controls}><span>{filteredEvents.length} available</span><button type="button"><SlidersHorizontal size={17} /> Filters</button></div></div>
