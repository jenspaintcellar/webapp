...
export default function RegistrationPage() {
  ...
  async function beginRegistration(formEvent: FormEvent) {
    ...
    setMessage(emailError ? emailError.message : 'Check your email. Open the secure link on any device to finish your registration.');
    setLoading(false);
  }
  ...
  return <main className="registration-page">
    <div className="registration-card">
      ...
      <form onSubmit={beginRegistration} className="registration-form">
        ...
        <button disabled={loading} className="primary-button" type="submit">{loading ? 'Sending secure link...' : 'Continue with email verification'}</button>
      </form>
